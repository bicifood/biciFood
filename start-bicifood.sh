...
if curl -s http://localhost:8080/api/v1/actuator/health > /dev/null; then
    ...
    WEB_URL="http://localhost:3000/html/versio-final-TEA3/"
    echo "   Frontend servidor: http://localhost:3000/html/versio-final-TEA3/"
    ...
    echo "========================================"
    echo "✅ Frontend: http://localhost:3000/html/versio-final-TEA3/"
